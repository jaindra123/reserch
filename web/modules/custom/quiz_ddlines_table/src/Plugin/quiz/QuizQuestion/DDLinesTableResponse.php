...
class DDLinesTableResponse extends QuizResultAnswer {
  ...
  public function score($values): ?int {
    ...
    $this->set('field_drag_drop_tb_ans_response', $values['answer']);
    return NULL;
  }


  public function getResponse() {
    return $this->get('field_drag_drop_tb_ans_response')->getString();
  }
  ...
  public function getFeedbackValues(): array {
    ...
    $data[] = [
      ...
      // choices.
      'choice' => NULL,
      'attempt' => $this->get('field_drag_drop_tb_ans_response')->getString(),
      'correct' => $icon,
