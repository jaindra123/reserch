...
class DDLinesResponse extends QuizResultAnswer {
  ...
  public function score($values): ?int {
    ...
    $correct = $question->get('field_correct_ordering_answer')->getString();
    $this->set('field_drag_drop_answer_response', $values['answer']);
    return NULL;
  }


  public function getResponse() {
    return $this->get('field_drag_drop_answer_response')->getString();
  }
  ...
  public function getFeedbackValues(): array {
    ...
    $data[] = [
      ...
      // choices.
      'choice' => NULL,
      'attempt' => $this->get('field_drag_drop_answer_response')->getString(),
      'correct' => $icon,
      'score' => !$this->isEvaluated() ? $this->t('This answer has not yet been scored.') : $this->getPoints(),
      'solution' => $this->getQuizQuestion()->get('field_correct_ordering_answer')->getString(),
