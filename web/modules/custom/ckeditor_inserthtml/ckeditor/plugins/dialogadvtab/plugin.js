				...
				if ( tabConfig.classes ) {
					contents.push( {
						...
						children: [ {
							...
							att: 'class',
							type: 'select',
							items: [ ['pinkHeadcolor'], ['tealHeadcolor'],['blueHeadcolor'],['tealColor'],['blueColor'],['pinkColor'],['tealBgColor'],['blueBgColor'],['pinkBgColor'],['w_100' ],['w_50'] ],
							requiredContent: element ? element + '(cke-xyz)' : null,
							label: lang.cssClasses,
							'default': 'blueHeadcolor',
							setup: setupAdvParams,
							commit: commitAdvParams
