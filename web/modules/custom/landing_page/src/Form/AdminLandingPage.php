...
class AdminLandingPage extends ConfigFormBase
{
	...
	{   
        ...
        $config = $this->config('landing_page.admin.settings');
	...
	{
        // \Drupal::configFactory()->getEditable('landing_page.admin.settings')->delete();
        $config = $this->config('landing_page.admin.settings');
