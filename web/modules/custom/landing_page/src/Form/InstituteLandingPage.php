...
class InstituteLandingPage extends ConfigFormBase
{

	protected function getEditableConfigNames() {
        return [
            'landing_page.institute.settings',
        ];
    }

    public function getFormId() {
        return 'institute_landing_page';
    }
	...
	{   
        ...
        $config = $this->config('landing_page.institute.settings');
	...
	{
        // \Drupal::configFactory()->getEditable('landing_page.institute.settings')->delete();
        $config = $this->config('landing_page.institute.settings');
